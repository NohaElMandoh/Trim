...
@section('title', __('Viewing').' '.ucfirst(__('lessons')))
@section('content')
<div class="row">
    <div class="box">
        <div class="box-header">
            @can('lesson.create')
                <a href="{{ route('lessons.create') }}"  class="btn btn-primary"> {{ __('Add New')}}
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-left" lesson="menu">
                                    @can('lesson.view')
                                    <li>
                                        <a href="{{ route('lessons.show', $row->id) }}">
                                            <i class="fa fa-eye"></i> {{ __('View') }} </a>
                                    </li>
                                    @endcan
                                    @can('lesson.edit')
                                    <li>
                                        <a href="{{ route('lessons.edit', $row->id) }}">
...
<!-- Modal -->
<div id="delete_modal" class="modal fade" lesson="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="delete_form" method="POST" action="{{ route('lessons.destroy', 0) }}">
                    @csrf
                    @method('DELETE')
