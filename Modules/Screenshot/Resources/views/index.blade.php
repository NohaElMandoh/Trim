...
@section('title', __('Viewing').' '.ucfirst(__('screenshots')))
@section('content')
<div class="row">
    <div class="box">
        <div class="box-header">
            @can('screenshot.create')
                <a href="{{ route('screenshots.create') }}"  class="btn btn-primary"> {{ __('Add New')}}
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-left" screenshot="menu">
                                    @can('screenshot.view')
                                    <li>
                                        <a href="{{ route('screenshots.show', $row->id) }}">
                                            <i class="fa fa-eye"></i> {{ __('View') }} </a>
                                    </li>
                                    @endcan
                                    @can('screenshot.edit')
                                    <li>
                                        <a href="{{ route('screenshots.edit', $row->id) }}">
                                            <i class="fa fa-pencil-square-o"></i> {{ __('Edit') }} </a>
                                    </li>
                                    @endcan
                                    @can('screenshot.delete')
                                    <li>
...
<!-- Modal -->
<div id="delete_modal" class="modal fade" screenshot="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="delete_form" method="POST" action="{{ route('screenshots.destroy', 0) }}">
                    @csrf
                    @method('DELETE')
