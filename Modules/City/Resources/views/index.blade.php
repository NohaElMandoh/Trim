...
@section('title', __('Viewing').' '.ucfirst(__('cities')))
@section('content')
<div class="row">
    <div class="box">
            ...
            <table class="table table-striped table-bordered" id="example1"> 
                ...
                <tbody>
                    ...
                    <tr>
                        <td> {{ $row->id }} </td>
                        <td> {{ $row->name }} </td>
                        <td> {{ $row->governorate()->first()->name ?? '' }} </td>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-left" cities="menu">
                                    @can('city.view')
                                    <li>
...
<!-- Modal -->
<div id="delete_modal" class="modal fade" cities="dialog">
