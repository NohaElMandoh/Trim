...
@section('title', __('Viewing').' '.ucfirst(__('phones')))
@section('content')
<div class="row">
        <div class="box">
            <div class="box-header">
            @can('phone.create')
                    <a href="{{ route('phones.create') }}"  class="btn btn-primary"> {{ __('Add New')}}
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-left" role="menu">
                                        @can('phone.view')
                                        <li>
                                            <a href="{{ route('phones.show', $row->id) }}">
                                                <i class="fa fa-eye"></i> {{ __('View') }} </a>
                                        </li>
                                        @endcan
                                        @can('phone.edit')
                                        <li>
                                            <a href="{{ route('phones.edit', $row->id) }}">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="delete_form" method="POST" action="{{ route('phones.destroy', 0) }}">
                    @csrf
                    @method('DELETE')
