...
@section('title', __('Viewing').' '.ucfirst(__('captains')))
@section('content')
<div class="row">
    <div class="box">
        <div class="box-header">
            @can('captain.create')
                <a href="{{ route('captains.create') }}"  class="btn btn-primary"> {{ __('Add New')}}
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-left" captain="menu">
                                    @can('captain.view')
                                    <li>
                                        <a href="{{ route('captains.show', $row->id) }}">
                                            <i class="fa fa-eye"></i> {{ __('View') }} </a>
                                    </li>
                                    @endcan
                                    @can('captain.edit')
                                    <li>
                                        <a href="{{ route('captains.edit', $row->id) }}">
                                            <i class="fa fa-pencil-square-o"></i> {{ __('Edit') }} </a>
                                    </li>
                                    @endcan
                                    @can('captain.edit')
                                    <li>
                                        <a href="{{ route('captains.password', $row->id) }}">
                                            <i class="fa fa-pencil-square-o"></i> {{ __('Change password') }} </a>
                                    </li>
                                    @endcan
                                    @can('captain.delete')
                                    <li>
...
<!-- Modal -->
<div id="delete_modal" class="modal fade" captain="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="delete_form" method="POST" action="{{ route('captains.destroy', 0) }}">
                    @csrf
                    @method('DELETE')
