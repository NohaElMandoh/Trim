...
@section('title', __('Viewing').' '.ucfirst(__('courses')))
@section('content')
<div class="row">
    <div class="box">
        <div class="box-header">
            @can('course.create')
                <a href="{{ route('courses.create') }}"  class="btn btn-primary"> {{ __('Add New')}}
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-left" course="menu">
                                    @can('course.view')
                                    <li>
...
<!-- Modal -->
<div id="delete_modal" class="modal fade" course="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="delete_form" method="POST" action="{{ route('courses.destroy', 0) }}">
                    @csrf
                    @method('DELETE')
