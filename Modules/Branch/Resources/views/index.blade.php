...
@section('title', __('Viewing').' '.ucfirst(__('branches')))
@section('content')
<div class="row">
        <div class="box">
            <div class="box-header">
            @can('branch.create')
                    <a href="{{ route('branches.create') }}"  class="btn btn-primary"> {{ __('Add New')}}
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="delete_form" method="POST" action="{{ route('branches.destroy', 0) }}">
                    @csrf
                    @method('DELETE')
