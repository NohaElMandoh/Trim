...
@section('title', __('Viewing').' '.ucfirst(__('emails')))
@section('content')
<div class="row">
        <div class="box">
            <div class="box-header">
            @can('email.create')
                    <a href="{{ route('emails.create') }}"  class="btn btn-primary"> {{ __('Add New')}}
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-left" role="menu">
                                        @can('email.view')
                                        <li>
                                            <a href="{{ route('emails.show', $row->id) }}">
                                                <i class="fa fa-eye"></i> {{ __('View') }} </a>
                                        </li>
                                        @endcan
                                        @can('email.edit')
                                        <li>
                                            <a href="{{ route('emails.edit', $row->id) }}">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="delete_form" method="POST" action="{{ route('emails.destroy', 0) }}">
                    @csrf
                    @method('DELETE')
