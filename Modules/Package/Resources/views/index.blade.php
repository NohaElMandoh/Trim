...
@section('title', __('Viewing').' '.ucfirst(__('packages')))
@section('content')
<div class="row">
    <div class="box">
        <div class="box-header">
            @can('package.create')
                <a href="{{ route('packages.create') }}"  class="btn btn-primary"> {{ __('Add New')}}
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-left" package="menu">
                                    @can('package.view')
                                    <li>
                                        <a href="{{ route('packages.show', $row->id) }}">
...
<!-- Modal -->
<div id="delete_modal" class="modal fade" package="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="delete_form" method="POST" action="{{ route('packages.destroy', 0) }}">
                    @csrf
                    @method('DELETE')
