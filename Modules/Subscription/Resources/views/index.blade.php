    ...
    <div class="box">
        <div class="box-header">
            @can('subscriptions.create')
                <a href="{{ route('subscription.create') }}"  class="btn btn-primary"> {{ __('Add New')}}
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-left" subscription="menu">
                                    @can('subscriptions.view')
                                    <li>
                                        <a href="{{ route('subscription.show', $row->id) }}">
                                            <i class="fa fa-eye"></i> {{ __('View') }} </a>
                                    </li>
                                    @endcan
                                    @can('subscriptions.edit')
                                    <li>
                                        <a href="{{ route('subscription.edit', $row->id) }}">
...
<!-- Modal -->
<div id="delete_modal" class="modal fade" subscription="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="delete_form" method="POST" action="{{ route('subscription.destroy', 0) }}">
                    @csrf
                    @method('DELETE')
