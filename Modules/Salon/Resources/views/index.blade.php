...
<div class="row">
    <div class="box">
        <div class="box-header">
            @can('salon.create')
                <a href="{{ route('salons.create') }}"  class="btn btn-primary"> {{ __('Add New')}}
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-left" salon="menu">
                                    @can('salon.view')
                                    <li>
                                        <a href="{{ route('salons.show', $row->id) }}">
                                            <i class="fa fa-eye"></i> {{ __('View') }} </a>
                                    </li>
                                    @endcan
                                    @can('salon.edit')
                                    <li>
                                        <a href="{{ route('salons.edit', $row->id) }}">
                                            <i class="fa fa-pencil-square-o"></i> {{ __('Edit') }} </a>
                                    </li>
                                    @endcan
                                    @can('salon.edit')
                                    <li>
                                        <a href="{{ route('salons.password', $row->id) }}">
...
<!-- Modal -->
<div id="delete_modal" class="modal fade" salon="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="delete_form" method="POST" action="{{ route('salons.destroy', 0) }}">
                    @csrf
                    @method('DELETE')
