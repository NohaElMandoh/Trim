...
@section('title', __('Viewing').' '.ucfirst(__('governorates')))
@section('content')
<div class="row">
    <div class="box">
        <div class="box-header">
            @can('governorate.create')
                <a href="{{ route('governorates.create') }}"  class="btn btn-primary"> {{ __('Add New')}}
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-left" governorate="menu">
                                    @can('governorate.view')
                                    <li>
                                        <a href="{{ route('governorates.show', $row->id) }}">
                                            <i class="fa fa-eye"></i> {{ __('View') }} </a>
                                    </li>
                                    @endcan
                                    @can('governorate.edit')
                                    <li>
                                        <a href="{{ route('governorates.edit', $row->id) }}">
...
<!-- Modal -->
<div id="delete_modal" class="modal fade" governorate="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="delete_form" method="POST" action="{{ route('governorates.destroy', 0) }}">
                    @csrf
                    @method('DELETE')
