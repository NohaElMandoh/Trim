...
@section('title', __('Viewing').' '.ucfirst(__('More way')))
@section('content')
...
<div class="panel panel-default">
    <div class="panel-heading">{{ __('Delivery locations map') }}</div>
    <div class="panel-body">
        <div id="delivery-canvas" class="form-control"></div>
    </div>
</div>
<div class="panel panel-default">
    <div class="panel-heading">{{ __('Buy location') }}</div>
    <div class="panel-body">
...
@endif
<div class="panel panel-default">
    <div class="panel-heading">{{ __('Delivery locations') }}</div>
    <div class="panel-body">
        @foreach ($row->delivery_locations()->get() as $delivery_location)
        <div class="panel panel-default">
            <div class="panel-heading">{{ $delivery_location->name }} - {{ $delivery_location->phone }}</div>
            <div class="panel-body">
                @foreach($delivery_location->items()->get() as $item)
                <div class="col-md-3">
...
@endforeach
var map1 = new google.maps.Map(document.getElementById('buy-canvas'), {
    center:{
        lat: {{ $row->buy_lat }},
        lng: {{ $row->buy_lng }}
    },
