...
@section('title', __('Change status').' '.ucfirst(__('More way')))
@section('content')
<form role="form" class="form-horizontal" method="POST" action="{{ route('moreway_orders.status', $row->id) }}" enctype="multipart/form-data">
    @csrf
    <div class="form-body">
