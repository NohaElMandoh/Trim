...
@section('title', __('Change status').' '.ucfirst(__('Any where')))
@section('content')
<form role="form" class="form-horizontal" method="POST" action="{{ route('anywhere_orders.status', $row->id) }}" enctype="multipart/form-data">
    @csrf
    <div class="form-body">
