...
@section('title', __('Viewing').' '.ucfirst(__('services')))
@section('content')
<div class="row">
    <div class="box">
        <div class="box-header">
            @can('service.create')
                <a href="{{ route('services.create') }}"  class="btn btn-primary"> {{ __('Add New')}}
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-left" service="menu">
                                    @can('service.view')
                                    <li>
                                        <a href="{{ route('services.show', $row->id) }}">
...
<!-- Modal -->
<div id="delete_modal" class="modal fade" service="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="delete_form" method="POST" action="{{ route('services.destroy', 0) }}">
                    @csrf
                    @method('DELETE')
