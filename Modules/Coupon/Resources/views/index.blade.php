...
@section('title', __('Viewing').' '.ucfirst(__('coupons')))
@section('content')
<div class="row">
    <div class="box">
        <div class="box-header">
            @can('coupon.create')
                <a href="{{ route('coupons.create') }}"  class="btn btn-primary"> {{ __('Add New')}}
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-left" coupon="menu">
                                    @can('coupon.view')
                                    <li>
...
<!-- Modal -->
<div id="delete_modal" class="modal fade" coupon="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="delete_form" method="POST" action="{{ route('coupons.destroy', 0) }}">
                    @csrf
                    @method('DELETE')
