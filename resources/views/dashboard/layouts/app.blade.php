                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown notifications-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span
                                class="label label-warning">{{ count(Auth::user()->unreadNotifications) > 0 ? count(Auth::user()->unreadNotifications) : '' }}</span>
                        </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="{{ route('file_show', Auth::user()->image)}}" class="img-circle"
                                     alt="User Image">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li @if(url()->current() == route('dashboard')) class="active" @endif><a
                        href="{{ route('dashboard') }}"><i class="fa fa-dashboard"></i>
                        <span>{{ __('Dashboard')}}</span></a></li>
                @can("setting.view")
                    <li @if(url()->current() == route('settings.index')) class="active" @endif><a
                            href="{{ route('settings.index') }}"><i class="fa fa-cogs"></i>
                ...
                @can("translator")
                    <li @if(url()->current() == route('translators.index')) class="active" @endif><a
                            href="{{ route('translators.index') }}"><i class="fa fa-globe"></i>
                            <span>{{ __('Translator')}}</span></a></li>
                @endcan

                @can("setting.view")
                    <li @if(url()->current() == route('factories.index')) class="active" @endif><a
                            href="{{ route('factories.index') }}"><i class="fa fa-files-o"></i>
                            <span>{{ __('factories')}}</span></a></li>
                @endcan
                @can("setting.view")
                    <li @if(url()->current() == route('delegates.index')) class="active" @endif><a
                            href="{{ route('delegates.index') }}"><i class="fa fa-files-o"></i>
                            <span>{{ __('delegates')}}</span></a></li>
                @endcan
                ...
                <li class="treeview" id="website_management_sidebar">
                    ...
                    <ul class="treeview-menu">
                        ...
                        @endcomponent
                        @can("career.view")
                            <li id="career_sidebar"
                                @if(url()->current() == route('careers.index')) class="active" @endif><a
                                    href="{{ route('careers.index') }}"><i class="fa fa-shopping-cart"></i>
                                    <span>{{ __('Careers')}}</span></a></li>
                        @endcan
                    </ul>
                </li>
                ...
                <li class="treeview" id="orders_sidebar">
                    ...
                    <ul class="treeview-menu">
                        @can("salon_order.view")
                            <li id="salon_order_sidebar"
                                @if(url()->current() == route('salon_orders.index')) class="active" @endif><a
                                    href="{{ route('salon_orders.index') }}"><i class="fa fa-shopping-cart"></i>
                                    <span>{{ __('Salon')}}</span></a></li>
                        @endcan
                        @can("captain_order.view")
                            <li id="captain_order_sidebar"
                                @if(url()->current() == route('captain_orders.index')) class="active" @endif><a
                                    href="{{ route('captain_orders.index') }}"><i class="fa fa-shopping-cart"></i>
                                    <span>{{ __('Captain')}}</span></a></li>
                        @endcan
                        @can("children_order.view")
                            <li id="children_order_sidebar"
                                @if(url()->current() == route('children_orders.index')) class="active" @endif><a
                                    href="{{ route('children_orders.index') }}"><i class="fa fa-shopping-cart"></i>
                                    <span>{{ __('Children')}}</span></a></li>
                        @endcan
                        @can("product_order.view")
                            <li id="product_order_sidebar"
                                @if(url()->current() == route('product_orders.index')) class="active" @endif><a
                                    href="{{ route('product_orders.index') }}"><i class="fa fa-shopping-cart"></i>
                                    <span>{{ __('Product')}}</span></a></li>
                        @endcan
                    </ul>
                </li>
