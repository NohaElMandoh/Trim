...
@section('content')
    <form role="form" class="form-horizontal" method="POST" action="{{ route('delegates.update', $row->id) }}"
                    ...
                    <div class="col-md-10">
                        <select class="js-example-basic-single js-states form-control" id="city_id" name="city_id">
                            ...
                            @foreach(\Modules\City\Entities\City::latest()->get() as $city)
                                <option value="{{ $city->id }}" @if ($row->city_id == $city->id) selected @endif>{{ $city->name }}</option>
                            @endforeach
                        </select>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-10">
                    <select class="js-example-basic-single js-states form-control" id="roles[]" name="roles[]"
                        ...
                        <option value="5" selected>{{ucfirst(__('delegates'))}}</option>
